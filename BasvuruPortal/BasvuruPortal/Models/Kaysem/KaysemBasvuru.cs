...
namespace BasvuruPortal.Models.Kaysem
{
    ...
    public class KaysemBasvuru
    {
        ...
        [Required(ErrorMessage = "Başvuru Formu alanı boş geçilemez!")]
        public string Basvuru_Formu { get; set; }
        [Required(ErrorMessage = "Dekont alanı boş geçilemez!")]
        public string Dekont { get; set; }
        [Required(ErrorMessage = "Diğer Belgeler alanı boş geçilemez!")]
